# -*- encoding: utf-8 -*-
# stub: middleman-sprockets 3.5.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<sprockets>.freeze, ["~> 2.12.1"])
      s.add_runtime_dependency(%q<sprockets-sass>.freeze, ["~> 1.3.0"])
      s.add_runtime_dependency(%q<sprockets-helpers>.freeze, ["~> 1.1.0"])
    else
      s.add_dependency(%q<middleman-core>.freeze, [">= 3.3"])
      s.add_dependency(%q<sprockets>.freeze, ["~> 2.12.1"])
      s.add_dependency(%q<sprockets-sass>.freeze, ["~> 1.3.0"])
      s.add_dependency(%q<sprockets-helpers>.freeze, ["~> 1.1.0"])
    end
  else
    s.add_dependency(%q<middleman-core>.freeze, [">= 3.3"])
    s.add_dependency(%q<sprockets>.freeze, ["~> 2.12.1"])
